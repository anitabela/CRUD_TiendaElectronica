...
// PANEL FORMULARIO
        JPanel panelFormulario = new JPanel(new GridLayout(4, 2, 10,
                10));
...
// EVENTOS
        ...
        tabla.getSelectionModel().addListSelectionListener(e -> {
            ...
            if (fila >= 0) {
                txtNombre.setText(modeloTabla.getValueAt(fila,
                        1).toString());
                txtMarca.setText(modeloTabla.getValueAt(fila,
                        2).toString());
                txtPrecio.setText(modeloTabla.getValueAt(fila,
                        3).toString());
                txtStock.setText(modeloTabla.getValueAt(fila,
                        4).toString());
            }
        });
    }
